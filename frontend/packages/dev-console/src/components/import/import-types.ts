...
import { K8sResourceKind, ContainerPort } from '../../../../../public/module/k8s';
import { LazyLoader } from '../../../../console-plugin-sdk/src';
import { NameValuePair, NameValueFromPair } from '../../../../console-shared/src/components';
