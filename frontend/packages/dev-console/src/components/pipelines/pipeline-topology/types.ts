import { EdgeModel, NodeModel } from '../../../../../topology/src';
import {
  Pipeline,
...
export type PipelineBuilderTaskNodeModel = PipelineNodeModel<
  BuilderNodeModelData
>;
export type PipelineTaskListNodeModel = PipelineNodeModel<
