...
const AddValueButton = ({ appendConfigMapOrSecret }) => {
  const { t } = useTranslation();
  return (
    <span className="btn-link pairs-list__btn" onClick={appendConfigMapOrSecret}>
      <i aria-hidden="true" className="fa fa-plus-circle pairs-list__add-icon" />
      {t('CONTENT:ADDVALUEFROMCONFIGMAPORSECRET')}
    </span>
  );
};

export const NameValueEditor = DragDropContext(HTML5Backend)(
