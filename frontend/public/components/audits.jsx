...
class AuditPage_ extends React.Component {
  constructor(props) {
    ...
    this.resourcelist = {
      ...
      clusterpropagatedversions: 'clusterpropagatedversions',
      ...
      events: 'events',
      federatedclusterroles: 'federatedclusterroles',
      federatedconfigmaps: 'federatedconfigmaps',
      federateddeployments: 'federateddeployments',
      federatedingresses: 'federatedingresses',
      federatedjobs: 'federatedjobs',
      federatednamespaces: 'federatednamespaces',
      federatedreplicasets: 'federatedreplicasets',
      federatedsecrets: 'federatedsecrets',
      federatedserviceaccounts: 'federatedserviceaccounts',
      federatedservices: 'federatedservices',
      federatedservicestatuses: 'federatedservicestatuses',
      gateways: 'gateways',
      handlers: 'handlers',
      ...
      policies: 'policies',
      propagatedversions: 'propagatedversions',
      ...
      rolebindingclaims: 'rolebindingclaims',
